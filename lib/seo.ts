...
export function getHomepageMetaDescription() {
  return "Stand automovel em Coimbra com carros usados de qualidade, viaturas seminovas e acompanhamento transparente. A Up Motors tambem faz importacao automovel por encomenda para quem procura o carro certo com confianca.";
}

export function getStockMetaDescription() {
  return "Descubra carros usados em Coimbra, carros a venda em Coimbra e viaturas selecionadas pela Up Motors. Filtre por marca, combustivel, transmissao e encontre o carro certo com apoio especializado.";
}

export function getContactMetaDescription() {
  return "Fale com a Up Motors, o seu stand de confianca em Coimbra. Marque visita, peca informacoes sobre carros usados em Coimbra ou solicite apoio para importacao automovel por encomenda.";
}
